package com.zengfull.mycamera.camera.ui;
...
import com.zengfull.mycamera.R;
import com.zengfull.mycamera.camera.CameraManager;
import com.zengfull.mycamera.camera.model.PhotoItem;
import com.zengfull.mycamera.camera.util.CameraHelper;
import com.zengfull.mycamera.camera.util.ImageUtils;
import com.zengfull.mycamera.camera.widget.CameraGrid;
    ...
    private class SavePicTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!TextUtils.isEmpty(result)) {
                ...
                Toast.makeText(CameraActivity.this,"拍照失败，请稍后重试！", Toast.LENGTH_LONG);
            }
        }
    }
...
//        原始大小
        ...
        String imagePath = ImageUtils.saveToFile(Environment.getExternalStorageDirectory().getAbsolutePath() + "/DCIM/Camera", true,
                croppedImage);
    ...
    /**
     * 将拍下来的照片存放在SD卡中（只是单一保存数据，没对方向调整和前置相机的翻转）
     * @param data
     * @throws IOException
     */
//    public String saveToSDCard(byte[] data) throws IOException {
...
//        String filename = "IMG"+format.format(date) + ".jpg";
...
//    }
    ...
    private Bitmap decodeRegionCrop(byte[] data, Rect rect) {
        ...
        Matrix m = new Matrix();
        m.setRotate(90, rect.width() / 2, rect.height() / 2);
        if (mCurrentCameraId == 1) { //如果是前置相机，翻转
            m.postScale(1, -1);
        }
        Bitmap rotatedImage = Bitmap.createBitmap(croppedImage, 0, 0, rect.width(), rect.height(), m, true);
...
//        return croppedImage;
    ...
    private void setUpCamera(int mCurrentCameraId2) {
        ...
        if (cameraInst != null) {
            ...
            Toast.makeText(CameraActivity.this,"切换失败，请重试！", Toast.LENGTH_LONG);
        }
    }
